...
// import { FaStar, FaRupeeSign, FaInfoCircle, FaUser, FaPhone, FaEnvelope, FaTimes } from "react-icons/fa";
...
//   {/* Left - Image */}
//   <div className="flex-1 flex justify-center items-strech bg-red-600">
//     <img
//       src={service.image}
//       alt={service.name}
...
//       Refundable Deposit: <FaRupeeSign className="mx-1" /> {service.refundableDeposit}
//     </p>
...
//   {isModalOpen && (
//     <motion.div
//       className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50 p-4 backdrop-blur-md"
...
//   const relatedServices = ambulanceServices.filter((s) => s.id !== service.id);
...
//               className="min-w-[250px] bg-white rounded-xl shadow-md overflow-hidden border border-gray-200 hover:shadow-xl transition cursor-pointer"
...
//                 />
//                 <span className="absolute top-2 left-2 bg-[#8B0000] text-white px-2 py-1 text-xs rounded flex items-center gap-1 shadow-md">
...
//                     <FaHeartbeat /> ₹{item.rentPerHour}/hr
//                   </span>
//                 </div>
//               </div>
//             </motion.div>
...
import { motion, AnimatePresence } from "framer-motion";
import { useNavigate } from "react-router-dom";
import RelatedServices from "./RelatedServices"; // ✅ Import related services component
